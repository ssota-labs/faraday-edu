// Preschool game-view example — dialogue + character walk (no slide deck).
// Uses placeholder colors when assets are not yet in public/; add sprites via assets-2d pack.
...
export default function PreschoolCounting() {
  return (
    <Lecture
      ...
      lead="A short game scene — tap through dialogue, watch the character walk."
      views={[
        {
          id: "game",
          label: "Play",
              ...
              scenes={[
                {
                  ...
                  beats: [
                    ...
                    { type: "choice", prompt: "Pick a number", options: [
                      { label: "Two", jump: 5 },
                      { label: "Three", jump: 6 },
                    ]},
                    { type: "dialogue", speaker: "Bear", text: "Yes! Two flowers!" },
                    { type: "dialogue", speaker: "Bear", text: "Try again — count the red ones." },
                  ],
                },
              ]}
            />
