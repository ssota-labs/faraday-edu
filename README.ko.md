...
실행: npx skills add ssota-labs/faraday-academy/plugins/claude-code/skills/faraday
```
...
│  ├─ official-packs/           # 설치 가능한 모듈 팩 (three · tutor · srs · lecture-design) + pack.schema.json
...
| **렉쳐 구성** | `lecture-design` — 교수법 & 교육학 | ✅ 제공 중 | 스킬-온리 폴더 (5 moves + 5E/CRA/Peer Instruction/Mayer/Merrill) |
