...
> **Pack `game2d`:** installed via `faraday pack add game2d`. Authoring guide at `.faraday/packs/game2d`. Load it when the lesson needs a 2D game canvas — sprites, tilemaps, physics toys, or interactive stages built with PixiJS.
